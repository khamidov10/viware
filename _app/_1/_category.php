<?php
if(isset($_GET['del'])){
    $result = $db->query("DELETE FROM category WHERE id={$_GET['del']}");
}
if(isset($_POST['add'])){
    ...
    $result = $db->query("INSERT INTO category ($keys) VALUES ($values)");
}
...
<div class="row p-3 bg-white rounded">
    <div class="col-12 text-end my-3">
        <button data-bs-toggle="modal" data-bs-target="#addForm" class="btn btn-primary">Yangi bo'lim</button>
    </div>
     <?php
        if(isset($message)){
    echo "
    ...
    <form class="modal-content" action="" method="POST">
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-6 mb-3">
               <label for="inn">Russ tilida raqami:</label>
