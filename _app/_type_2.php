...
$go_pages = [
  "main" => "Tovarlar",
    "new"=>"Yangi tovar",
    "orders"=>"Buyurtmalar",
    "load"=>"Нагрузка (Qo'shimcha tovar)",
    "info" => "Diller Ma'lumotlari",
    "edit" => "Sozlash",
    "orderview" => "Buyurtma haqida",
    "credit" => "Qarzdorlik",
    "sms" => "SMS marketing"
    ];
if(isset($_GET['go'])){
	...
	<div class="col-12 head h-40 shadow-sm sticky">
		<div class="container h-100">
			...
			<ul class="col-6  col-md-9 m-0 list-unstyled topIcon" align="right">
				<li class="d-inline-block mx-1" notify="<?php echo $_SESSION['userId'];?>">
...
<script>
    ...
    <script>
        ...
        $("[cancelid]").click(function(){
              $id = $(this).attr("cancelid")
            $("#cancelOrder").attr('action','/?go=orders&action=3&id='+$id)
