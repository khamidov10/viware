...
$order = $db->query("SELECT * FROM order_items WHERE order_id={$_GET['id']}");

$orderinfo = $db->query("SELECT * FROM orders WHERE id={$_GET['id']}")->fetch_assoc();
$dill = $db->query("SELECT * FROM users WHERE id={$orderinfo['diller']}")->fetch_assoc();
...
<div class='table-responsive'>
   <table class="table table-bordered w-50 mx-auto " style="z-index:2">
       <tr>
       ...
       <tr>
           <td>Yetkazib beruvchi raqami</td>
           <td><b><a href="tel:+998<?php echo $client['phone'];?>">+998<?php echo $dill['phone'];?></a></b></td>
       </tr>
       <tr>
           <td>Buyurtmachi</td>
